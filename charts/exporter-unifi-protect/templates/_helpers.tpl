...
*/}}
{{- define "exporter-unifi-protect.secretName" -}}
{{- if .Values.unifiProtect.existingSecret }}
{{- .Values.unifiProtect.existingSecret }}
{{- else }}
{{- include "exporter-unifi-protect.fullname" . }}
{{- end }}
{{- end }}
...
Image to use
*/}}
{{- define "exporter-unifi-protect.image" -}}
